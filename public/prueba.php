            ...
            <div class="col-md-8 mx-auto">
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <?php elseif (isChofer()): ?>
                            <a href="registroVehiculos.php" class="btn btn-success btn-lg mt-3">Registrar Vehículo</a>
                        <?php elseif (isAdmin()): ?>
                            <a href="admin/pendientes.php" class="btn btn-warning btn-lg mt-3">Panel de Administración</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
