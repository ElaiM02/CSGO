                    ...
                    <div class="col">
                        <div class="card veh-card shadow-sm h-100">
                            <div class="card-body d-flex flex-column">
                                ...
                                <h5 class="card-title"><?= htmlspecialchars($v['marca'] . ' ' . $v['modelo']) ?></h5>
                                <p class="text-muted mb-1"><i class="fas fa-id-card"></i> Placa: <strong><?= htmlspecialchars($v['placa']) ?></strong></p>
                                <p class="text-muted mb-1"><i class="fas fa-calendar"></i> Año: <?= $v['ano'] ?></p>
                                <p class="text-muted mb-3"><i class="fas fa-palette"></i> Color: <?= htmlspecialchars($v['color']) ?></p>

                                <div class="mt-auto">

                                    <div class="btn-group w-100">
                                        <a href="vehiculos_view.php?id=<?= $v['id'] ?>" class="btn btn-outline-info btn-sm"><i class="fas fa-eye"></i> Ver</a>
                                        <a href="vehiculos_edit.php?id=<?= $v['id'] ?>" class="btn btn-outline-warning btn-sm"><i class="fas fa-edit"></i> Editar</a>

                                        <button class="btn btn-outline-danger btn-sm"onclick="confirmDelete(<?= $v['id'] ?>, '<?= htmlspecialchars($v['marca'] . ' ' . $v['modelo']) ?>')">
