                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nombre_viaje" class="form-control" 
                                            value="<?php echo htmlspecialchars($nombre_viaje); ?>" maxlength="100" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">
                                        ...
                                        <select name="vehiculo_id" class="form-select" required>
                                            ...
                                            <?php foreach ($vehiculos as $veh): ?>
                                                <option value="<?php echo $veh['id']; ?>" <?php echo $vehiculo_id == $veh['id'] ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="precio_por_asiento" class="form-control" 
                                                value="<?php echo htmlspecialchars($precio_por_asiento); ?>" min="100" step="100" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">
